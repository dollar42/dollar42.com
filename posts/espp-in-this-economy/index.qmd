...
The money was only tied up for a few months at a time. And as the stock price crashed, **I still earned a 91.57% interest rate on my contributions**.
...
The _potential_ tax benefit of long-term capital gains rates is not compelling when weighed against the volatility of a single stock. One bad news story could wipe out the entire profit and more, and it becomes more likely the longer the shares remain unsold^[Some ESPPs restrict employees from selling their purchased shares immediately. That makes participating in the ESPP more risky, and it may be too risky for some people in these cases.].

## Interest Rates

Question: if an ESPP offers a 15% discount on shares every 6 months, is that equivalent to a 15% annualized interest rate?

No. **The ESPP earns about 91.57% annualized interest**.

91.57% is a much better deal than 15%.

Consider that an account with a 15% interest rate earns the full 15% only on money present in the account for the entire year.

By contrast, ESPP contributions are only tied up for 3 months on average (half of the purchase period), much less than an entire year.

Assuming contributions happen each bimonthly paycheck, the first contribution is escrowed for 6 months, the next for 5.5 months, etc. until the final one is escrowed for a few days. The overall average is 3 months.

A 15% discount applied over a 3 month period works out to an exceptionally high 91.57% annualized rate:
...
For instance, capturing the exceptional interest rate requires selling the shares as quickly as possible every time.

Even so, volatility in the stock price between the purchase date and when the stock can later be sold means the profit will inevitably be a little higher or lower than the calculators show. I set a recurring reminder for myself to remember to sell as quickly as feasible to reduce the impact of this volatility.
