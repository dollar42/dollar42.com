...
My investment spreadsheet is now available as a free template, and I am writing a series of posts on what it is and why I built it like I did.
...
If target and actual deviate too far, the Difference cells will become more yellow and eventually red, indicating that money should ideally start moving from overperforming asset classes to relatively underperforming ones ("sell high, buy low!").
...
US stocks are now 5.24 percentage points (cell B7) from target. $114,579 (cell B10) needs to flow from other asset classes into US Stocks to rebalance exactly. It's not dire compared to their total portfolio size, but it is a little out of balance.
...
For this example, I will go to the Transactions sheet to make two new entries:

![A trial rebalance in the Transactions sheet](rebalance_in_action.png)

These rows represent an exchange Alice could _consider_:

1. A sale of $115,000 (_negative_) of FXNAX, a nominal bond fund. $115,000 is my rounded version of the $114,579 inflow (from earlier) needed to rebalance the US Stocks asset class.
1. With the proceeds, a purchase of $115,000 (_positive_ shares) of FSKAX, a US stock fund.
...
Although there is more to do, this exchange would help get the portfolio closer to alignment with its new target. If it hadn't, I would quickly delete the two mock transactions and try something else.

Mocking out possible trades all at once has made rebalancing a lot more easy for me. And it is much quicker in a spreadsheet than most other tools.

## Summary

I am a long-term investor. That requires:
...
A portfolio of millions of dollars can be managed with a spreadsheet when it is constructed from a thoughtful handful of high quality, low fee funds in a small set of diversified asset classes. Complex investments or complicated management are not necessarily required even at relatively high balances.
