...
What if Alice and Bob experiment with raising their stock allocation to 75% (from 65%)? In the Asset Allocation sheet:
...
The Rebalance Matrix sheet automatically regenerates^[Sometimes it does not automatically regenerate, but a value in the orange cell B2 can be changed to force it to recalculate]:
...
1. A sale (negative shares) of $115,000 of FXNAX, a fund in the Nom. Bonds category that is currently overweight by $133,486 (cell D10).
