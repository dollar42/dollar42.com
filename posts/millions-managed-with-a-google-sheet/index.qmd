...
If I were Alice and Bob, I would open the spreadsheet every few months to update transactions and check for growing deviations. Close monitoring would not be required.
...
2. Sticking to the plan over many decades.
